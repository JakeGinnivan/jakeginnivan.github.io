...
Awesome! It has automated our app, and put a task in. The test is still not much use as we are not verifying that our app is actually working.

Post in progress... found a bug in Funnelweb to do with Feeds. Oops125